...
public class ShowRequestInfoDialog extends DialogFragment {

    private static final String ARG_ROOM_TYPE = "roomType";
    private static final String ARG_DESCRIPTION = "description";

    public static ShowRequestInfoDialog newInstance(String room_type, String description) {
        Bundle args = new Bundle();

        ShowRequestInfoDialog fragment = new ShowRequestInfoDialog();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.dialog_show_order_info, container, false);
